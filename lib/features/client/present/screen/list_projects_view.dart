...
class ListProjectsView extends StatefulWidget {
  const ListProjectsView({super.key});

  @override
  State<ListProjectsView> createState() => _ProjectsViewState();
}

class _ProjectsViewState extends State<ListProjectsView> {
  final List<ListProjectsModel> _allProjects = [
    ListProjectsModel(
  ...
  List<ListProjectsModel> _filteredProjects = [];
...
class _FilterChips extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final categories = ['all', 'uiuxDesign', 'mobileAppDesign'];
        ...
        children: categories.asMap().entries.map((entry) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: isFirst
                  ? AppColors
                        .secondary200 // Peach color for "All"
...
class _ProjectsList extends StatelessWidget {
  final List<ListProjectsModel> projects;
...
class _ProjectItem extends StatelessWidget {
  final ListProjectsModel project;
