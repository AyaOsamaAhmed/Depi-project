...
class RoomChatView extends StatefulWidget {
  ...
  @override
  State<RoomChatView> createState() => _ViewState();
}

class _ViewState extends State<RoomChatView> {
  ...
  final List<Map<String, dynamic>> _messages = [
    ...
    {
      'text':
          'lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dumt',
      'isSender': true,
    },
    {
      'text':
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: const AssetImage(
                      'assets/images/client_profile.png',
                    ),
                  ),
                  SizedBox(width: 12.w),
                  Column(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: state is MessageSending
                  ...
                  : Icon(Icons.send_rounded, color: Colors.white, size: 24.r),
            ),
          ),
        ],
      ),
