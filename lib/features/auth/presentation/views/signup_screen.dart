...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void _collectAndProceed(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      context.read<SignupCubit>().collectData(
      ...
      context.push(AppRoutes.chooseRole, extra: _emailController.text.trim());
    }
  }
